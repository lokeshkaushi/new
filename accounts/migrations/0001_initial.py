    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workad_at', models.CharField(blank=True, max_length=100, null=True)),
                ('Studied_at', models.CharField(blank=True, max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Social',
        ...
        migrations.AddField(
            ...
            name='Profile_Pic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='accounts.profile_pic'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
